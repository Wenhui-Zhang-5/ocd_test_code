...
export default function Spectrum({ workspaceId }) {
  ...
  const displayToolOptions = withSelected(toolOptions, [machineId]);
  const displayRecipeOptions = withSelected(recipeOptions, [recipeName]);
  const displayLotOptions = withSelected(lotOptions, [lotId]);
  const displayWaferOptions = withSelected(
    waferOptions,
    Array.isArray(selectedWafers) ? selectedWafers : []
  );
